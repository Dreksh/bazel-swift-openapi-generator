...
for folder in Examples IntegrationTest Tests; do echo "# gazelle:exclude" > "$folder/BUILD.bazel"; done
git add .
...
sed -n '/^use_repo/p' MODULE.bazel >> "${BUILD_WORKSPACE_DIRECTORY}/MODULE.bazel"
rm MODULE.bazel .bazelrc MODULE.bazel.lock # These aren't needed in the patch
